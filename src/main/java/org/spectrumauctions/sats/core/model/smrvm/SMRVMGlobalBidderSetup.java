 ...
 *
 */
public class SMRVMGlobalBidderSetup extends SMRVMBidderSetup {
    ...
    protected SMRVMGlobalBidderSetup(Builder builder) {
        super(builder);
    }
     ...
     * @return
     */
    public Map<Integer, BigDecimal> drawGamma(SMRVMWorld world, UniformDistributionRNG rng) {
    ...
    public static class Builder extends SMRVMBidderSetup.Builder{
         ...
         */
        @Override
        public SMRVMGlobalBidderSetup build() {
            return new SMRVMGlobalBidderSetup(this);
        }
