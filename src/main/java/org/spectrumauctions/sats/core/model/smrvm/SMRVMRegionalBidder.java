 ...
 *
 */
public final class SMRVMRegionalBidder extends SMRVMBidder {
     ...
     * @param rng
     */
    SMRVMRegionalBidder(long id, long populationId, SMRVMWorld world, SMRVMRegionalBidderSetup setup,
     ...
     * @return
     */
    private void validateDistanceDiscounts(SMRVMWorld world, SortedMap<Integer, BigDecimal> discounts){
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SMRVMRegionalBidder other = (SMRVMRegionalBidder) obj;
