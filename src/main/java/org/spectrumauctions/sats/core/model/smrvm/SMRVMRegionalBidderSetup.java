 ...
 *
 */
public class SMRVMRegionalBidderSetup extends SMRVMBidderSetup {

    private final double exponentFactor;
    private final double base;
    

    protected SMRVMRegionalBidderSetup(Builder builder) {
        super(builder);
     ...
     * @return
     */
    public Region drawHome(SMRVMWorld world, UniformDistributionRNG rng) {
     ...
     * @return
     */
    public ImmutableSortedMap<Integer, BigDecimal> drawDistanceDiscounts(SMRVMWorld world, Region home, UniformDistributionRNG rng) {
    ...
    public static class Builder extends SMRVMBidderSetup.Builder{
        ...
        /**
         * Specify the Gamma Function, i.e., the discount the regional bidder has on values for regions with distance d from his home (i.e., {@link SMRVMRegionsMap#getDistance(home, d)}<br><br>
         ...
         */
        @Override
        public SMRVMRegionalBidderSetup build() {
            return new SMRVMRegionalBidderSetup(this);
        }
