 ...
 *
 */
public final class SMRVMGenericDefinition implements GenericDefinition {

    private final SMRVMBand band;
     ...
     * @param quantity
     */
    public SMRVMGenericDefinition(SMRVMBand band, Region region) {
        super();
    ...
    public boolean isPartOf(Good license) {
        if(license == null){
            return false;
        }else if(!(license instanceof SMRVMLicense)){
            return false;
        }else{
            SMRVMLicense l = (SMRVMLicense) license;
    ...
    */
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SMRVMGenericDefinition other = (SMRVMGenericDefinition) obj;
        if (band == null) {
            if (other.band != null)
                return false;
    ...
    public Set<Good> allLicenses() {
        if(licenses == null){
            ...
            for(SMRVMLicense lic : band.getLicenses()){
