 ...
 *
 */
public final class SMRVMWorldSetup {
    ...
    private SMRVMWorldSetup(SMRVMWorldSetupBuilder builder) {
        super();
    ...
    public static final class RegionSetup {
        ...
        //Hack to use regular MRVM Methods TODO: Extract common superclasses from MRVM and SMRVM
        public MRVMWorldSetup.RegionSetup toMRVMSetupType(){
            return new MRVMWorldSetup.RegionSetup(populationMean, populationStandardDeviation, notice);
        }
    }
    ...
    public static class SMRVMWorldSetupBuilder {
     ...
     //       cornerPoints.put(BigDecimal.valueOf(2), BigDecimal.valueOf(1.4));
        ...
        public SMRVMWorldSetup build(){
            return new SMRVMWorldSetup(this);
